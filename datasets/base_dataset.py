...
class TrainBaseTransform(object):
    ...
    """
    def __init__(self, input_size, hflip, vflip, rotate, crop_size):
    ...
    def __call__(self, image, mask):
        ...
        transform_fn = transforms.CenterCrop(self.crop_size)
        image, mask = transform_fn(image), transform_fn(mask)
        if self.hflip:
